...
var clientApp = new Moonboots({
    jsFileName: 'localAdventures',
    cssFileName: 'localAdventures',
...
console.log('Local Adventures is running at: http://localhost:' + config.http.port + ' Yep. That\'s pretty awesome.');
